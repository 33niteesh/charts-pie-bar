...
export default function Web3() {
    ...
    return (
        <div className="sub-2">
            <top className="sub-head"><p className="sub-heading">Web 3.0 Domains<k style={{ fontSize: 20, color: 'grey' }}> show : </k><k className="this">This month ↓</k></p><img src={report} style={{ width: 450 }} /></top>
