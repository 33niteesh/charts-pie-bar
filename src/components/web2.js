...
export default function Web2() {
    ...
    return (
        <div className="sub-2">
            <top className="sub-head"><p className="sub-heading">Web 2.0 Domains<k style={{ fontSize: 20, color: 'grey' }}> show : </k><k className="this">This month ↓</k></p><img src={report} style={{ width: 450 }} /></top>
            <bottom style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                <left style={{ height: 600 }}>
                    <div style={{ height: 600, width: 300, display: 'flex', flexDirection: 'column', padding: 5, justifyContent: 'start',marginLeft:'3rem', alignItems: 'start' }}>
                        <p style={{ fontSize: 20, fontWeight: 'bold' }}>web 2.0 summary</p>
                        <br>
                        </br>
                        <div class="pie" style={{
                            backgroundImage: 'conic-gradient(rgb(255, 68, 0) 64%, rgb(82, 82, 247) 64%, rgb(64, 64, 177) 81%, rgb(122, 222, 76) 81%)'
                        }}>
                            <div style={{ width: '5rem', height: '5rem', borderRadius: '20rem', backgroundColor: 'white' }}></div>
                        </div>
